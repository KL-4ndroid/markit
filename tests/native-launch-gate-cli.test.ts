...
const cliPath = resolve('scripts/check-native-launch-readiness.ts');
const canonicalPath = resolve(
  'docs/subscription/NATIVE_SUBSCRIPTION_LAUNCH_GATES_2026_08_06.json',
);
const temporaryDirectory = mkdtempSync(join(tmpdir(), 'boothbook-native-launch-gates-'));
...
console.log('PASS Native launch gate CLI exits');
