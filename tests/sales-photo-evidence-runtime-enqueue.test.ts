...
const testPageSource = readFileSync(join(projectRoot, 'app/debug/sales-photo-evidence/page.web.tsx'), 'utf8');
const testWorkbenchSource = readFileSync(join(projectRoot, 'components/markets/SalesPhotoEvidenceTestWorkbench.tsx'), 'utf8');
const ownerMarketDetailSource = readFileSync(join(projectRoot, 'components/markets/MarketDetailScreen.tsx'), 'utf8');
