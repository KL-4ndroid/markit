...
assert.match(workspaceSource, /const selectedMode = controlledMode \?\? mode/);
assert.match(workspaceSource, /hidden=\{selectedMode !== 'quick'\}/);
assert.match(workspaceSource, /hidden=\{selectedMode !== 'products'\}/);
