  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <div className="gradient-header pt-12 pb-8 px-6 rounded-b-[2rem]">
        <div className="max-w-lg mx-auto">
          <div className="flex items-center justify-between mb-2">
            <div className="h-8 w-32 bg-white/20 rounded-lg skeleton-shimmer"></div>
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-white/20 rounded-full skeleton-shimmer"></div>
              <div className="w-10 h-10 bg-white/20 rounded-full skeleton-shimmer"></div>
            </div>
          </div>
          <div className="h-4 w-48 bg-white/10 rounded skeleton-shimmer"></div>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-6 -mt-4 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="text-center">
                <div className="h-3 w-16 bg-gray-200 rounded mx-auto mb-2 skeleton-shimmer"></div>
        ...
        {/* 市集卡片骨架 */}
        <div>
          <div className="h-6 w-32 bg-gray-200 rounded mb-4 skeleton-shimmer"></div>
