      ...
      <div className="gradient-header pt-12 pb-8 px-6 rounded-b-[2rem]">
        <div className="max-w-lg mx-auto">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="h-8 w-24 bg-white/20 rounded-full skeleton-shimmer"></div>
          </div>
      ...
      <div className="max-w-lg mx-auto px-6 -mt-4 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          {[1, 2, 3, 4].map((i) => (
            ...
            >
              <div className="h-8 w-20 bg-gray-200 rounded mb-2 skeleton-shimmer"></div>
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-lg shadow-[#7B9FA6]/10">
          ...
          <div className="h-48 bg-gray-50 rounded-xl skeleton-shimmer"></div>
        </div>
