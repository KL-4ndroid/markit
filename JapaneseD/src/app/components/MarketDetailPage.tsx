      ...
      <div className="max-w-lg mx-auto px-6 -mt-4">
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-lg shadow-primary/10 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-foreground">營業狀態</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-[#FFF8E7] rounded-xl p-4">
              ...
              <div className="text-foreground text-xl tabular-nums">{stats.sales}</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-lg shadow-primary/10 mb-6">
          <h3 className="text-foreground mb-4">客戶互動</h3>
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            ...
            >
              ...
              <div className="text-foreground text-xs">觸摸商品</div>
            </button>
            ...
            >
              <div className="text-3xl mb-2">💬</div>
              <div className="text-foreground text-xs">詢問</div>
            </button>
            ...
            >
              <div className="text-3xl mb-2">✅</div>
              <div className="text-foreground text-xs">成交</div>
            </button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 pt-4 border-t border-primary/10">
            <div className="text-center">
              ...
              <div className="text-foreground tabular-nums">{stats.touches}</div>
            </div>
            <div className="text-center">
              <div className="text-[#6B6B6B] text-xs mb-1">詢問</div>
              <div className="text-foreground tabular-nums">{stats.inquiries}</div>
            </div>
            <div className="text-center">
              <div className="text-[#6B6B6B] text-xs mb-1">成交</div>
              <div className="text-primary tabular-nums">{stats.sales}</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-lg shadow-primary/10 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-foreground">購物車</h4>
                <p className="text-[#6B6B6B] text-sm">{cartItems} 件商品</p>
              </div>
            </div>
            <button className="bg-primary text-white px-5 py-2.5 rounded-xl hover:bg-[#6B8F96] transition-colors">
              結帳
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-lg shadow-primary/10 mb-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-foreground">數據儀表板</h3>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-primary tabular-nums">{conversionRate}%</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-secondary tabular-nums">{inquiryRate}%</span>
              </div>
            ...
            <div className="grid grid-cols-3 gap-3 pt-3">
              <div className="bg-[#F5E6E8] rounded-xl p-3 text-center">
                ...
                <div className="text-foreground tabular-nums">45人</div>
              </div>
              <div className="bg-[#E8F3E8] rounded-xl p-3 text-center">
                <DollarSign className="w-4 h-4 text-primary mx-auto mb-1" />
                <div className="text-xs text-[#6B6B6B]">均價</div>
                <div className="text-foreground tabular-nums">$1,563</div>
              </div>
              <div className="bg-[#FFF8E7] rounded-xl p-3 text-center">
                ...
                <div className="text-foreground tabular-nums">↑ 12%</div>
              </div>
            </div>
          </div>
        </div>
