  ...
  return (
    <>
      <button
        ...
        className="w-full p-6 bg-gradient-to-br from-[#7B9FA6] to-[#6A8E95] rounded-[1.5rem] shadow-lg hover:shadow-xl transition-all"
      >
      ...
      {showModal && platform === 'ios' && (
        <div className="fixed inset-0 bg-black/50 z-[100] flex items-end sm:items-center sm:justify-center p-4">
          <div className="bg-white rounded-t-[2rem] sm:rounded-[2rem] w-full max-w-md p-6">
            ...
            <button
              onClick={() => setShowModal(false)}
              className="w-full px-6 py-3 rounded-2xl bg-[#7B9FA6] text-white hover:bg-[#6A8E95] transition-colors font-medium"
            >
              我知道了
            </button>
          </div>
