  ...
  return (
    <div className="flex flex-col items-start gap-2 sm:items-end">
      <button
        ...
        disabled={isDisabled}
        className="inline-flex h-10 items-center justify-center gap-2 border border-[#26392F] bg-[#26392F] px-4 text-sm font-medium text-white transition hover:bg-[#315F43] disabled:cursor-not-allowed disabled:border-[#BDB5AA] disabled:bg-[#BDB5AA]"
      >
