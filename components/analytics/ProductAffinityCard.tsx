    ...
    return (
      <div className="bg-white rounded-[1.5rem] p-6 shadow-lg shadow-primary/10">
        <div className="animate-pulse">
          <div className="h-6 bg-primary/10 rounded w-1/2 mb-4"></div>
          <div className="space-y-3">
            <div className="h-16 bg-primary/5 rounded-xl"></div>
            <div className="h-16 bg-primary/5 rounded-xl"></div>
            <div className="h-16 bg-primary/5 rounded-xl"></div>
          </div>
        </div>
  ...
  if (!pairs || pairs.length === 0) {
    return (
      <div className="bg-white rounded-[1.5rem] p-6 shadow-lg shadow-primary/10">
        ...
        {/* ✅ 溫柔的建議提示 */}
        <div className="bg-soft-yellow rounded-xl p-6 text-center">
          <div className="w-16 h-16 mx-auto mb-4 bg-secondary/10 rounded-full flex items-center justify-center">
            <ShoppingBag className="w-8 h-8 text-secondary/60" />
          </div>
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-right">
                <p className="text-xs text-muted-foreground">共同出現</p>
