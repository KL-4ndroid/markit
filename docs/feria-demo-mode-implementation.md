...
- Demo 範例資料：提供 13 場市集（1 場營運中、2 場準備中、10 場已結束）、12 項商品與 10 筆現場動態。
- 市集案例涵蓋雨天虧損、高營收高成本、低人流高轉換、高人流低轉換、節慶高客單、客群不匹配、跨城市出攤與新品牌基準場等情境。
- 市集清單與單場復盤會顯示情境標籤；分析只採計營運中或已結束的場次，避免把尚未發生的準備中市集納入趨勢。
- 商品案例涵蓋全部正式分類、停售歷史商品與不限庫存服務項目。
