-- SRA-A1 OBSERVED BASELINE LOCAL REVIEW DRAFT
...
-- Baseline: SRA-000 matched Production metadata read 2026-08-26, replayed on localhost.
-- No remote migration ledger exists; this is NOT a deployable numbered migration.
